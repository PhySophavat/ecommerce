<template>
    <div class="chatgpt-admin min-h-screen bg-[#F8FAFC] px-3 py-3 sm:px-4 lg:px-6 lg:py-5">
        <div class="mx-auto flex min-h-[calc(100vh-1.5rem)] max-w-[1600px] overflow-x-clip rounded-[30px] border border-[#E5E7EB] bg-[#F8FAFC] shadow-[0_18px_42px_rgba(15,23,42,0.06)]">
            <AdminSidebar
                :dashboard="dashboard"
