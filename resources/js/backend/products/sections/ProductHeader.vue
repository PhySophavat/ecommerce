<template>
    <header class="border-b border-slate-200/80 bg-white/85 px-4 py-4 backdrop-blur sm:px-6 lg:px-8">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
                <p class="chatgpt-kicker text-[11px] uppercase text-slate-400">{{ dashboard.meta.kicker }}</p>
                <h2 class="chatgpt-title mt-2 text-3xl text-slate-950 sm:text-4xl">{{ dashboard.meta.page_title }}</h2>
