<template>
    <div class="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
        <section class="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
            ...
            <div class="mt-6 rounded-3xl border border-dashed border-slate-300 bg-[#fff7fb] px-4 py-4 text-sm text-slate-600">
        ...
        <section class="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
            ...
            <h2 class="mt-2 text-2xl font-extrabold tracking-[-0.04em] text-slate-950">Send payout request</h2>
            ...
            <form v-else class="mt-6 space-y-4" @submit.prevent="submit">
                <label class="block">
                    ...
                    <select v-model="form.bank_account_id" class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#A25F88]">
                ...
                <button type="submit" class="w-full rounded-2xl bg-[#A25F88] px-5 py-3 text-sm font-semibold text-white transition hover:opacity-90" :disabled="isSubmitting || !canSubmit">
                    Submit Withdrawal
                </button>
            </form>
        </section>
