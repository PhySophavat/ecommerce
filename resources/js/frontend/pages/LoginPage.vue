<template>
    <div class="flex min-h-screen items-center justify-center bg-[#F8FAFC] px-4 py-10">
        <div class="grid w-full max-w-6xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
            <section class="rounded-[36px] bg-[linear-gradient(145deg,#111827,#1f2937)] p-8 text-white shadow-[0_28px_70px_rgba(17,24,39,0.14)]">
                <p class="text-xs font-semibold uppercase tracking-[0.24em] text-[#F9A8D4]">Welcome back</p>
            ...
            <section class="rounded-[36px] border border-[#E5E7EB] bg-white p-8 shadow-sm">
                ...
                <p class="mt-6 text-sm text-[#6B7280]">
                    Need an account?
                    <RouterLink to="/register" class="font-semibold text-[#A25F88]">Register here</RouterLink>
                </p>
            </section>
        </div>
    </div>
