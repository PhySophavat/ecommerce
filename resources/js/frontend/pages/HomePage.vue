<template>
    <div class="py-8">
        ...
        <section class="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div class="overflow-hidden rounded-[36px] bg-white p-8 shadow-[0_24px_60px_rgba(17,24,39,0.06)] sm:p-10">
                <p class="text-xs font-semibold uppercase tracking-[0.28em] text-[#A25F88]">{{ store.meta?.eyebrow || 'Soft modern storefront' }}</p>
            ...
            <div class="overflow-hidden rounded-[36px] bg-[linear-gradient(145deg,#A25F88,#111827)] p-8 text-white shadow-[0_24px_60px_rgba(17,24,39,0.14)]">
        ...
        <section class="mt-14 rounded-[36px] bg-[linear-gradient(145deg,#111827,#1f2937)] px-8 py-10 text-white shadow-[0_28px_70px_rgba(17,24,39,0.14)]">
            <div class="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.22em] text-[#F9A8D4]">Promotion banner</p>
        ...
        <section class="mt-14 grid gap-5 md:grid-cols-3">
            <article v-for="item in whyChooseUs" :key="item.title" class="rounded-[30px] border border-[#E5E7EB] bg-white p-6 shadow-sm">
                <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F3E8F1] text-[#A25F88]">
...
const whyChooseUs = [
    { icon: '✓', title: 'Trusted merchants', text: 'Every product on the storefront comes from managed merchants and a cleaner admin workflow.' },
    { icon: '♡', title: 'Friendly shopping', text: 'The interface is designed to feel soft, simple, and easy for customers on every screen size.' },
    { icon: '⚡', title: 'Smooth checkout', text: 'Cart, checkout, and merchant payment flow are connected so buying and payout tracking feel immediate.' },
];
